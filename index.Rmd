...
simulate_core <- function(input, n_executions_game, solve_game = FALSE){
  ...
  simulate_executions <- function(values, n_executions, combination, return_results = FALSE){
  ...
  results_game <- furrr::future_map2_dfr(
    ...
    .f = ~simulate_executions(values = .x, n_executions = n_game, combination = .y, return_results = solve_game ),
    progress = TRUE,
