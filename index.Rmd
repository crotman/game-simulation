...
source("R/utility_functions.R", encoding = "UTF-8")
...
observeEvent( input$solve_all_no_memo , {
  ...
  tib_process_fraction_review_game <-  tibble(
    process_fraction_review_game = c(0, 10, 20, 30, 40, 50, 60, 70, 80)
  )
  ...
  harm_degrees <- c("1", "1.0025", "1.005", "1.0075", "1.01", "1.0125", "1.015", "1.0175", "1.02")
  ...
  tib_characteristics_kludges_harmful_game <- tibble(
    ...
    order = c(1, 1.0025, 1.005, 1.0075, 1.01, 1.0125, 1.015, 1.0175, 1.02)
  )
  ...
  all_params <- all_params_all %>% 
    ...
    #retirar agora
    filter(
      # process_fraction_review_game %in% c(30),
      process_fraction_metareview_game == c(0)
      # characteristics_kludges_harmful_game %in% c(1, 1.0025, 1.005, 1.0075, 1.01, 1.0125, 1.015, 1.0175, 1.02)
    ) %>%
    identity()
