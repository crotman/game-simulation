...
inputPanel(
  ...
  numericInput(
    inputId = "total_time_multi",
    label = "Simulation time",
    value = "500",
    step = 1
  ) ,
  selectInput(
    inputId = "prob_diligent_multi",
    label = "Probability of Kludge when Diligent",
    selected = "0.2",
  ...
  selectInput(
    inputId = "prob_negative_when_correct_kludgy_accurate_multi",
    label = "Probability of Negative when Correct Review of Kludgy PR and Accurate",
    selected = "0.2",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_correct_not_kludgy_accurate_multi",
    label = "Probability of Negative when Correct Review of Not Kludgy PR and Accurate",
    selected = "0.2",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_incorrect_kludgy_accurate_multi",
    label = "Probability of Negative when Incorrect Review of Kludgy PR and Accurate",
    selected = "0.8",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_incorrect_not_kludgy_accurate_multi",
    label = "Probability of Negative when Incorrect Review of Not Kludgy PR and Accurate",
    selected = "0.8",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_correct_kludgy_inaccurate_multi",
    label = "Probability of Negative when Correct Review of Kludgy PR and Inaccurate",
    selected =  "0.4",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_correct_not_kludgy_inaccurate_multi",
    label = "Probability of Negative when Correct Review of Not Kludgy PR and Inaccurate",
    selected = "0.2",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_incorrect_kludgy_inaccurate_multi",
    label = "Probability of Negative when Incorrect Review of Kludgy PR and Inaccurate",
    selected = "0.8",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_negative_when_incorrect_not_kludgy_inaccurate_multi",
    label = "Probability of Negative when Incorrect Review of Not Kludgy PR and Inaccurate",
    selected = "0.9",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  numericInput(
    inputId = "mean_time_diligent_multi",
    label = "Mean Time to Develop when Diligent",
    value = "5",
    step = "1"
  ) ,
  ...
  numericInput(
    inputId = "mean_time_kludgy_multi",
    label = "Mean Time to Develop when Kludgy",
    value = "3",
    step = "1"
  ) ,
  ...
  numericInput(
    inputId = "mean_time_accurate_multi",
    label = "Mean Time to Meta-review when Accurate",
    value = "2",
    step = "1"
  ) ,
  ...
  numericInput(
    inputId = "mean_time_inaccurate_multi",
    label = "Mean Time to Meta-review when Inaccurate",
    value = "2",
    step = "1"
  ) ,
  ...
  numericInput(
    inputId = "sd_time_meta_review_multi",
    label = "Stdev of Time to review",
    value = "0.5",
    step = "0.1"
  ) ,
  ...
  numericInput(
    inputId = "mean_time_review_multi",
    label = "Mean Time to Review",
    value = "2",
    step = "1"
  ) ,
  ...
  selectInput(
    inputId = "prob_kludgy_review_when_kludge_careful_multi",
    label = "Probability of Kludge Review when Kludge and Careful",
    selected = "0.8",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_kludgy_review_when_not_kludge_careful_multi",
    label = "Probability of Kludge Review when No Kludge and Careful",
    selected = "0.2",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_kludgy_review_when_kludge_negligent_multi",
    label = "Probability of Kludge Review when Kludge and Negligent",
    selected = "0.6",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_kludgy_review_when_not_kludge_negligent_multi",
    label = "Probability of Kludge Review when No Kludge and Negligent",
    selected =  "0.2",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "action_d1_multi",
    label = "Developer 1 Pure Strategy",
    choices = c("Diligent/Accurate", "Diligent/Innaccurate", "Kludgy/Accurate", "Kludgy/Innaccurate" )
  ) ,
  
  selectInput(
    inputId = "action_d2_multi",
    label = "Developer 2 Pure Strategy",
    choices = c("Diligent/Accurate", "Diligent/Innaccurate", "Kludgy/Accurate", "Kludgy/Innaccurate" )
  ) ,
  
  selectInput(
    inputId = "action_r_multi",
    label = "Reviewer Pure Strategy",  
    choices = c("Careful", "Negligent")
  ) ,
  
  selectInput(
    inputId = "prob_review_multi",
    label = "Probability of a pull request to be reviewed",
    selected =  "0.3",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
  ...
  selectInput(
    inputId = "prob_meta_review_multi",
    label = "Probability of a review to be meta-reviewed",
    selected =  "0.3",
    choices = seq(0.1, 0.9, 0.1),
    multiple = TRUE
